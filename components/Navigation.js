        ...
        <div className="w-full">
          <nav className="flex flex-wrap items-center justify-between py-2 top-0 fixed w-full z-50 bg-white drop-shadow-sm">
            <div className="xl:container w-full relative px-4 mx-auto flex flex-wrap items-center justify-between">
              ...
              <div
                className={
                  "lg:flex flex-grow  lg:items-center bg-white lg:bg-transparent shadow h-screen lg:h-[unset] w-[70%] lg:w-[unset] max-w-xs lg:max-w-full lg:shadow-none lg:p-5 absolute right-0 top-[calc(100%+.5rem)] lg:static z-30 " +
