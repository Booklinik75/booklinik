...
const EditOffer = ({
  ...
  const currentOfferSurgery = groupedOptions.find((group) =>
    group.options.find((option) => option.value === currentOffer.surgery)
  );

  // determine offer hotel room against groupedHotelRooms using the id of the current offer
  const currentOfferHotelRoom = groupedHotelRooms.find((group) =>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                defaultValue={currentOfferSurgery.options.find(
                  (option) => option.value === offer.surgery
                )}
              />
              <p className="text-gray-500 text-xs italic">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                defaultValue={currentOfferHotelRoom.options.find(
                  (option) => option.value === offer.hotelRoom
                )}
              />
            </div>
            <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              {/* red deletion button that removes the firebase object, shows a success toast on success and redirects to the offer list */}
              <button
                className="transition bg-red-500 hover:bg-white text-white border border-red-500 hover:text-red-500 hover:bg-white
                    font-bold py-3 px-6 rounded focus:outline-none focus:shadow-outline"
                type="button"
                onClick={deleteOffer}
              >
                Supprimer
